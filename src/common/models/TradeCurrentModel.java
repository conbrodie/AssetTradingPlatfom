 ...
 * data contained with a record of the CurrentTrade database table.
 */
public class TradeCurrentModel {
    ...
    private int price;
    // Needed for Jackson to parse the sql Timestamp variable
    ...
    public boolean equals(Object obj) {
        if (! (obj instanceof TradeCurrentModel)) {
            return false;
        }
        if (this == obj) return true;

        TradeCurrentModel tcm = (TradeCurrentModel) obj;
        return tcm.trade_id == this.trade_id;
    }
}
