...
public class JSONLoginResult {
     ...
     *     This JSON string is transferred over the network, when is arrives at its destination it is (deserialised)
    ...
    public JSONLoginResult(String success, String message, String password, String details, String errorMessage, String clientName) {
