...
public class ServerLogicCommandsAssetHoldingTest {
     ...
     */
    @Test
    public void testGetAssetHoldingWhenNotLoggedIn() throws JsonProcessingException {
    ...
    @Test
    public void testGetAssetHoldingWithLoggedInAnNull() throws JsonProcessingException {
        db = new AssetHoldingDbMock(null, null, null);
    ...
    @Test
    public void testGetAssetHoldingWithLoggedInAndValidResult() throws JsonProcessingException {
     ...
     */
    @Test
    public void testCreateAssetHoldingWhenNotLoggedIn() throws JsonProcessingException {
        db = new AssetHoldingDbMock(null, null, null);
    ...
    @Test
    public void testCreateAssetHoldingWithLoggedInvalid() throws JsonProcessingException {
    ...
    @Test
    public void testCreateAssetHoldingWithLoggedInAndValidResult() throws JsonProcessingException {
     ...
     */
    @Test
    public void testUpdatingAssetHoldingWhenNotLoggedIn() throws JsonProcessingException {
        db = new AssetHoldingDbMock(null, null, null);
        JSONAction obj = new JSONAction();
        String expected = "{\"errorMessage\":\"Password was not valid, Are you logged in!\",\"message\":null,\"success\":\"0\"}";
        assertEquals(expected, ServerLogicCommands.manageAssetHolding(false, obj, db));
    ...
    @Test
    public void testUpdatingAssetHoldingWithLoggedInvalid() throws JsonProcessingException {
    ...
    @Test
    public void testUpdatingAssetHoldingWithLoggedInAndValidResult() throws JsonProcessingException {
